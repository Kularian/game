...
label label001(location="Infirmary"):
    if plotprogress == 2:
        ...
        label label001TalkB:
            show screen Infirmaryb
            hide natsumisprite
            hide saekosprite
            hide setsukosprite
            call screen Infirmaryb
            if _return > 0:
                show natsumisprite downleft stand at npc1loc
                show saekosprite downleft stand at npc2loc
                show setsukosprite bed at npc3loc
            if _return == 1:
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
    ...
    if plotprogress == 2:
        ...
        label label003TalkB:
            ...
            if _return == 1:
                ...
                $ naoyay = npc1y+25
                show naoyasprite upright stand at naoyaloc with qdis
                show student2sprite downleft standmove
...
label label004(location="Class 1-4"):
    if plotprogress == 2:
        ...
        #play appropriate music #update
        label label004TalkB:
            show screen Class14b
            hide student6sprite
            call screen Class14b
            if _return > 0:
                show student6sprite downleft stand at npc1loc
            if _return == 1:
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
                show naoyasprite upright stand at naoyaloc with qdis
...
label label005(location="Class 1-6"):
    if plotprogress == 2:
        ...
        #play appropriate music #update
        label label005TalkB:
            show screen Class16b
            hide student9sprite
            call screen Class16b
            if _return > 0:
                show student9sprite downleft stand at npc1loc
            if _return == 1:
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
                show naoyasprite upright stand at naoyaloc with qdis
                show student9sprite downleft standmove
    ...
    if plotprogress == 2:
        ...
        label label006TalkA:
            ...
            if _return == 1:
                ...
                show naoyasprite upleft stand at naoyaloc with qdis
                stu "Ms. Ooishi is so kind."
                stu "She loves flowers so much, she cares for them as if they were her children."
...
label label007(location="Teacher's Lounge"):
    if plotprogress == 2:
        ...
        #play appropriate music #update
        label label007TalkB:
            show screen TeacherLoungeB
            hide teachersprite
            call screen TeacherLoungeB
            if _return > 0:
                show teachersprite downleft stand at npc1loc
            if _return == 1:
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
                show naoyasprite upright stand at naoyaloc with qdis
        ...
        label label007TalkA:
            ...
            if _return > 0:
                ...
                show yukinosprite downright stand at yukinoloc
                show teacher downleft stand at npc1loc
                show marksprite upright stand at markloc
            ...
            if _return == 1:
                ...
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
                show teacher downleft standmove at npc1loc
                show naoyasprite upright stand at naoyaloc with qdis
    ...
    if plotprogress == 6:
        ...
        label label011TalkC:
            ...
            if _return == 1:
                ...
                $ naoyay = npc1y+25
                show naoyasprite upleft stand at naoyaloc with qdis
                show student3sprite downright standmove
    ...
    if plotprogress >= 2:
        ...
        label label012TalkA:
            ...
            if _return == 1:
                ...
                show student6 downleft standmove at npc2loc
                show naoyasprite upright stand at naoyaloc with qdis
                stu "St. Hermelin won the drama concours nine years ago, too..."
                stu "But the trophy from that year is missing."
    ...
    if plotprogress >= 2:
        ...
        label label014TalkA:
            ...
            if _return == 1:
                ...
                show naoyasprite upleft stand at naoyaloc with qdis
                show mark animated neutral smirk with qleft
                mk "There's a bunch of bows and arrows here."
                mk "I think I'll borrow one and mess around with it next time."
                show marksprite downright stand
                hide mark
                hide naoyasprite
                with qdis
...
label label015(location="Fencing Club"):
    if plotprogress >= 2:
        ...
        #play appropriate music #update
        if fencingclub2 == False:
            show screen fencingclubb
        ...
        label label015TalkB:
            ...
            if _return == 1:
                ...
                if tamakirapier == True:
                    ...
                    tm "Killing them isn't the only way to get things done."
                    $ label015atamaki = 1
        ...
        label label015TalkA:
            ...
            if _return > 0:
                ...
                show yukinosprite upleft stand at yukinoloc
                show marksprite upleft stand at markloc
                show tamakisprite downright stand at npc1loc
                show tadashisprite upleft stand at npc2loc zorder 1
                show student1 downright stand at npc3loc
                show student2 downright stand at npc4loc
            if _return == 1:
                $ naoyax = yukinox-60
                ...
                show naoyasprite downright stand at naoyaloc with qdis
                show yukino animated neutral serious with qleft
                yu "Leave 'em alone.  You know how some people are."
                yu "They fight 'cause they care."
                show yukinosprite upleft stand
                hide yukino
                hide naoyasprite
                with qdis
                ...
                $ naoyay = npc1y-25
                show tamakisprite upright standmove at npc1loc
                show naoyasprite downleft stand at naoyaloc zorder 0 with qdis
                show tamaki animated neutral serious with qleft
...
label label016(location="Ballet Club"):
    if plotprogress >= 2:
        ...
        label label016TalkA:
            ...
            hide nanjosprite
            hide yukinosprite
            call screen BalletClub
            if _return > 0:
                show nanjosprite downleft stand at nanjoloc
                show yukinosprite upleft stand at yukinoloc
                show marksprite downleft stand at markloc
                show student0 downright stand at npc1loc
                show student2 downright stand at npc2loc
            if _return == 1:
                $ naoyax = yukinox-60
                $ naoyay = yukinoy-25
                show yukinosprite upleft stand at yukinoloc
                ...
                $ naoyax = npc2x+60
                $ naoyay = npc2y+25
                show student2 downright standmove at npc2loc
                show naoyasprite upleft stand at naoyaloc with qdis
                stu "Did you know toe shoes are actually really hard?"
                stu "I was pretty surprised the first time I put on a pair."
                show student2 downright stand
                hide naoyasprite
                with qdis
                $ label016student2 = 1
    ...
    if plotprogress >= 2:
        ...
        label label018TalkA:
            ...
            if _return > 0:
                ...
                show yukinosprite upleft stand at yukinoloc
                show marksprite downright stand at markloc
                show student5 downright stand at npc1loc
            if _return == 1:
                $ naoyax = markx+60
                $ naoyay = marky+25
                show marksprite downright standmove at markloc
                ...
                $ naoyax = npc1x+60
                $ naoyay = npc1y+25
                show student5 downright standmove at npc1loc
                show naoyasprite upleft stand at naoyaloc with qdis
                stu "Don't you think derelict buildings should be torn down?"
                stu "Places like that only attract hooligans--"
                show mark animated neutral smirk with qleft
                show student5 downleft stand
                show naoyasprite downleft stand
                show marksprite upright standmove
                mk "Haha!  'Hooligans'?  Seriously?  What a poindexter!"
                hide mark with qdis
                show marksprite upright stand
                show student5 downleft standmove
                stu "Won't you pipe it down!?  As I was saying, wouldn't it attract hooligans?"
                show student5 downright standmove
                show naoyasprite upleft stand
                stu "I'd certainly hate to see that happen." (Name="Serious student")
                show student5 downright stand
                $ reijifactory = True
                hide naoyasprite
                with qdis
                $ label018student1 = 1
...
label label019(location="Class 2-2"):
    if plotprogress >= 2:
        ...
        $ npc1x = 1150
        $ npc1y = 200
        #play music schooldays volume 0.4 if_changed #update
        label label019TalkB:
            show screen Class22b
            hide student8
    ...
    if plotprogress >= 2:
        ...
        label label020TalkB:
            ...
            if _return == 1:
                ...
                stu "I don't think now is the time for that... Though it's admirable he's trying.  In his own way."
                show student8 downleft stand
                hide naoyasprite
                with qdis
                $ label022astudent1 = 1
...
label label022(location="Cafeteria"):
    if plotprogress >= 2:
        ...
        #play music schooldays volume 0.4 if_changed #update
        label label022TalkB:
            show screen Cafeteriab
            hide torosprite
            hide student7
            call screen Cafeteriab
            if _return > 0:
                show torosprite downleft stand at npc1loc
                show student7 upright stand at npc2loc
            if _return == 1:
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
                show torosprite downleft standmove at npc1loc
                show naoyasprite upright stand at naoyaloc with qdis
                show toro animated neutral serious with qleft
                ...
                if toro == False:
                    ...
                    $ tbnarrator = 0
                    $ toro = True
                show torosprite downleft stand
                hide toro
                hide naoyasprite
                with qdis
                $ label022atoro = 1
                ...
                $ naoyax = npc2x+60
                $ naoyay = npc2y-25
                show student7 upright standmove at npc2loc
                show naoyasprite downleft stand at naoyaloc with qdis
        ...
        label label022TalkA:
            ...
            if _return == 1:
                ...
                show naoyasprite upright stand at naoyaloc with qdis
                show mark animated neutral smirk with qleft
                mk "Toro's got balls, man!  I mean, asking out Ayase!?"
                mk "Dude... I wouldn't go after her in a million years!"
                show marksprite downleft stand
                hide mark
                hide naoyasprite
                with qdis
                ...
                show toro animated neutral smirk
    ...
    if plotprogress >= 2:
        ...
        label label023TalkA:
            ...
            if _return > 0:
                ...
                show yukinosprite downright stand at yukinoloc
                show marksprite downleft stand at markloc
                show student4 upright stand at npc1loc
                show student8 downleft stand at npc2loc
            if _return == 1:
                $ naoyax = markx-60
                $ naoyay = marky+25
                show marksprite downleft standmove at markloc
                ...
                $ naoyax = npc1x+80
                $ naoyay = npc1y+25
                show student4 upright standmove
                show naoyasprite upleft stand at naoyaloc with qdis
                ...
                show student4 upright stand
                show student8 downleft standmove
...
label label024: #Empty Classroom (Reiji)
    ...
    if reijiflags == 1:
        ...
        $ naoyax = 1000
        $ naoyay = 650
        scene bg emptyclassroom with qdis
        play music reiji fadeout 0.5 fadein 0.5
        show nanjosprite upleft stand at nanjoloc
        show yukinosprite upleft standmove at yukinoloc
        show marksprite upleft stand at markloc
        show reijisprite upleft stand at reijiloc
        show naoyasprite upleft stand at naoyaloc
        show yukino animated neutral serious with qleft
        yu "...Someone's there."
        hide yukino
        ...
        $ tbnarrator = 0
        hide reiji with qdis
        window hide
        $ newlocx = 600
        $ newlocy = 520
        show reijisprite downleft walk at newloc with MoveTransition(1.5)
        $ reijix = 600
        $ reijiy = 520
        show reijisprite downright stand at reijiloc
        show yukinosprite downleft stand
        show marksprite downleft stand
        show nanjosprite downleft stand
        show naoyasprite downleft stand
        $ newlocx = 900
        $ newlocy = 700
        show reijisprite downright walk at newloc with MoveTransition(2.5)
        hide reijisprite with qdis
        window auto
    ...
    if plotprogress >= 2:
        ...
        label label026TalkA:
            ...
            if _return == 1:
                ...
                $ naoyax = npc1x+60
                $ naoyay = npc1y+25
                show student1 downright standmove at npc1loc
                show naoyasprite upleft stand at naoyaloc with qdis
...
label label027 (location="Class 3-3"):
    if plotprogress >= 2:
        ...
        #play music schooldays volume 0.4 if_changed #
        label label027TalkB:
            show screen Class33a
            hide student9
            hide student0
            call screen Class33a
            if _return > 0:
                show student0 upleft stand at npc1loc
                show student9 downleft stand at npc2loc
            if _return == 1:
                $ naoyax = npc1x+60
                $ naoyay = npc1y+25
                show student0 downright standmove at npc1loc
                ...
                $ naoyax = npc2x-60
                $ naoyay = npc2y+25
                show student9 downleft standmove at npc2loc
                show naoyasprite upright stand at naoyaloc with qdis
    ...
    if plotprogress >= 2:
        ...
        label label028TalkA:
            ...
            if _return == 1:
                ...
                mk "It's not too far from the hospital."
                show marksprite downright stand
                hide mark
                hide naoyasprite
                with qdis
...
label label029 (location="Class 3-7"):
    if plotprogress >= 2:
        ...
        play music schooldays volume 0.4 if_changed
        label label029TalkB:
            show screen Class37a
            hide student8
            hide student1
            call screen Class37a
            if _return > 0:
                show student8 downright stand at npc2loc
                show student1 upleft stand at npc1loc
            if _return == 1:
                $ naoyax = npc1x+60
                $ naoyay = npc1y+25
                show student1 downright standmove at npc1loc
...
label label030 (location="Library"):
    if plotprogress >= 2:
        ...
        if plotprogress == 2:
            ...
            $ plotprogress = 3
        label label030TalkB:
            show screen Librarya
            hide student3
            hide student5
            hide tsutomusprite
            call screen Librarya
            if _return > 0:
                show student5 downright stand at npc2loc
                show tsutomusprite downleft stand at npc1loc
                show student3 upleft stand at npc3loc
            if _return == 1:
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
                show tsutomusprite downleft standmove at npc1loc
                show naoyasprite upright stand at naoyaloc with qdis
                show devilboy animated neutral serious with qleft
                db "You know of 'The Snow Queen,' right?  Yes... the fairy tale."
                db "It's the traditional play performed by St. Hermelin's drama club.  Eeheehee..."
                ...
                if devilboy == False:
                    ...
                    $ tbnarrator = 0
                    $ devilboy = True
                show tsutomusprite downleft stand
                hide naoyasprite
                hide devilboy
                with qdis
                $ label030atsutomu = 1
                ...
                $ naoyax = npc2x-60
                $ naoyay = npc2y+25
                show student5 downleft standmove at npc2loc
                show naoyasprite upright stand at naoyaloc with qdis
                stu "Hey, you!  You know something, don't you?  I'm begging you, help me out!"
                show student5 upright stand
                hide naoyasprite
                with qdis
                $ label030astudent2 = 1
            elif _return == 3:
                $ naoyax = npc3x-60
                $ naoyay = npc3y+25
                show student3 downleft standmove at npc3loc
                show naoyasprite upright stand at naoyaloc with qdis
                stu "You should be careful not to drive people into a corner."
                stu "Piss off a short-tempered guy, and who knows what he'll do?"
                stu "I bet the same is true for demons."
                show student3 downleft stand
                hide naoyasprite
                with qdis
                $ label030astudent3 = 1
            elif _return == 4:
        ...
        label label030TalkA:
            ...
            if _return == 1:
                ...
                show naoyasprite upright stand at naoyaloc with qdis
                show mark animated neutral serious with qleft
                mk "What're we doin' at the library?  Let's hurry and see M--I mean, get checked out!"
                show marksprite downright stand
                hide mark
                hide naoyasprite
                with qdis
                ...
                show naoyasprite upright stand at naoyaloc with qdis
                show devilboy animated neutral serious with qleft
                db "...Oh, it's you, Naoya.  Eeeheehee..."
                db "I'm investigating the seven mysteries of St. Hermelin High."
                show devilboy animated neutral smirk
                ...
                show student5 downleft standmove at npc2loc
                show naoyasprite upright stand at naoyaloc with qdis
                stu "They call him Devil-Boy, but the stuff he'll tell you is a load of crap."
                stu "I know much more about the occult."
                ...
                $ naoyax = npc4x+60
                $ naoyay = npc4y+25
                show student2 downright standmove at npc4loc
                show naoyasprite upleft stand at naoyaloc with qdis
...
label label031 (location="Student Council"):
    if plotprogress >=2:
        ...
        if plotprogress == 4:
            ...
            show student5 downright stand
        label label031TalkB:
            show screen StudentCouncilb
            hide student5
            hide student4
            call screen StudentCouncilb
            if _return > 0:
                show student5 downright stand at npc1loc
                show student4 upleft stand at npc2loc
            if _return == 1:
                $ naoyax = npc1x+60
                $ naoyay = npc1y+25
                show student5 downright standmove at npc1loc
                ...
                $ naoyax = npc4x-60
                $ naoyay = npc4y+25
                show student4 downleft standmove at npc4loc
                show naoyasprite upright stand at naoyaloc with qdis
        ...
        label label031TalkA:
            ...
            if _return > 0:
                ...
                show yukinosprite downright stand at yukinoloc
                show marksprite upleft stand at markloc
                show student5 downleft stand at npc1loc
                show student6 downright stand at npc2loc
                show student7 upleft stand at npc3loc
                show student4 downleft stand at npc4loc
            if _return == 1:
                $ naoyax = markx-60
                $ naoyay = marky-25
                ...
                $ naoyax = npc2x+60
                $ naoyay = npc2y-30
                show student6 upright standmove at npc2loc
                show naoyasprite downleft stand at naoyaloc with qdis
                ...
                $ naoyax = npc3x+60
                $ naoyay = npc3y+25
                show student7 downright standmove at npc3loc
                show naoyasprite upleft stand at naoyaloc with qdis
...
label label032 (location = "Art Room"):
    if plotprogress >= 2:
        ...
        #play music schooldays volume 0.4 if_changed #update
        label label032TalkB:
            show screen ArtRoomb
            hide student9
            call screen ArtRoomb
            if _return > 0:
                show student9 downleft stand at npc1loc
            if _return == 1:
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
                show student9 downleft standmove at npc1loc
                show naoyasprite upright stand at naoyaloc with qdis
...
label label033 (location="Entrance Hall"):
    if plotprogress == 2:
        ...
        #play appropriate music
        show saeko animated neutral serious with qleft
        sa "Hey, Naoya!  You're all safe!?  Oh, I'm so glad..."
        show saeko animated neutral sad
        ...
        hide yukino
        show saeko animated neutral serious with qleft
        sa "You're right!  Naoya, come with me to the infirmary!"
        ...
        el "Yes, let's go!"
        hide elly with moveoutleft
        n "Yukino and Elly have left." #update with these two actually moving
        show saeko animated neutral serious with qleft
        ...
        if yamaoka == False:
            ...
            show marksprite upright stand at markloc
            show naoyasprite upleft stand at naoyaloc
            show student3 downleft stand at npc1loc
            show student2 downright stand at npc2loc
            show nanjosprite downright standmove
            show nanjo animated neutral smirk with qleft
...
label label034 (location="Front Gate"):
    ...
    show marksprite downleft stand at markloc
    show naoyasprite downleft stand at naoyaloc
    show yamaokasprite upright stand at npc1loc
    ...
    $ tbnarrator = 0
    show yamaokasprite upright stand
    hide yamaoka with qdis
    show nanjo animated neutral serious with qleft
    show nanjosprite downleft standmove
    na "Y...Yamaoka..!"
    hide nanjo with qdis
    ...
    show yamaoka animated neutral serious with qleft
    show yamaokasprite upright standmove
    ya "Oh, my!  Master Kei is leaving the premises with a crowd of friends!"
    ya "I'm...I'm so happy to see this...!"
    hide yamaoka with qdis
    show yamaokasprite upright stand
    show mark animated neutral smirk with qleft
    show marksprite downright standmove
    ...
    na "N-No, I, ah... Oh, be silent, Masao!"
    show nanjosprite downleft standmove
    na "Look, Yamaoka, I don't need a ride today!  Just... go back without me!"
    show nanjosprite downleft stand
    hide nanjo with qdis
    show yamaoka animated neutral serious with qleft
    show yamaokasprite upright standmove
...
label label035 (location="Kaneda Mansion"):
    ...
    if plotprogress == 0:
        ...
        show kaneda at pleft2 with qleft
        show kanedasprite downright standmove
        kaneda "Hmph!  Children like you can't grasp my treasure's true worth!  "
        show kanedasprite upleft stand
        extend "Now get out of my sight!"
        hide kaneda with qdis
        hide screen header
        hide nanjosprite
        hide naoyasprite
...
label label038 (location="Alaya Shrine"):
    ...
    if plotprogress == 1:
        ...
        "The next Philemon Vid goes here tbh"
        hide bg black
        hide bg white
        with qdis
        show yukino animated neutral serious with qleft
    ...
    if plotprogress == 1:
        ...
        label label039TalkA:
            ...
            if _return == 1:
                ...
                show naoyasprite downright stand at naoyaloc with qdis
                show nanjo animated neutral serious with qleft
                na "True, we {i}could{/i} get checked out here..."
    ...
    if plotprogress == 1:
        ...
        label label041TalkB:
            ...
            if _return > 0:
                ...
                show marksprite upright stand at markloc
                show ellysprite upright stand at ellyloc
                show smdsprite downleft stand1 at npc1loc
            if _return == 1:
                $ naoyax = markx+60
                $ naoyay = marky+25
                show marksprite downright standmove at markloc
    ...
    if plotprogress == 0:
        ...
        label label042TalkA:
            ...
            if _return > 0:
                ...
                show yukinosprite upleft stand at yukinoloc
                show marksprite upright stand at markloc
                show woman1sprite upright stand at npc1loc
                show pdsprite downleft stand1 at npc2loc
            if _return == 1:
                $ naoyax = markx-60
                $ naoyay = marky+25
                show marksprite downleft standmove at markloc
                ...
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
                show woman1sprite downleft standmove at npc1loc
                show naoyasprite upright stand at naoyaloc with qdis
                ...
                show woman1sprite upright stand
                hide naoyasprite
                with qdis
                $ label042woman = 1
            elif _return == 5:
...
label label043 (location="Rosa Candida"): #Rosa Candida Mikage
    ...
    if plotprogress == 0:
        ...
        if rosacandidamark == False:
            ...
            show nanjosprite upleft stand at nanjoloc
            show naoyasprite upleft stand at naoyaloc
            show rcsprite downleft stand1 at npc1loc
            show markmomsprite upleft stand at npc2loc
            pause 0.5
            show markmomsprite downright standmove
            mmom "Massie!"
            show markmomsprite downright stand
            show mark animated neutral sad with qleft
            show marksprite upleft standmove
            ...
            show naoyasprite upleft stand at naoyaloc
            show rcsprite downleft stand1 at npc1loc
            mmom "Hey, Massie!  You came just in time!"
            mmom "I'm doing some shopping, but the load's piling up.  Help me out, Massie!"
            show markmomsprite downleft stand
            show nanjo animated neutral smirk with qleft
            show nanjosprite upright standmove
            ...
            mmom "Massie!  You'd call your own mother an old bat!?"
            mmom "And just when I was thinking of buying you some t-shirts!"
            show markmomsprite downleft stand
            show yukino animated neutral smirk with qleft
            show yukinosprite upleft standmove
            ...
            show marksprite upright stand
            show markmomsprite downleft standmove
            mmom "Oh, are these your friends?"
            mmom "My, this store is expensive. Look at this one, Massie!"
            show markmomsprite downleft stand
            show mark animated neutral serious with qleft
            show marksprite upright standmove
            mk "What do I want with that!?  "
            show marksprite downright standmove
        ...
        if rosacandidamark == True:
            ...
            hide mark
            show markmomsprite downright standmove
            mmom "Oh, Massie, you're back!  Perfect timing!"
            show markmomsprite downright stand
            show marksprite downright standmove
            show mark animated neutral serious with qleft
    ...
    if plotprogress == 1:
        ...
        label label044TalkB:
            ...
            if _return > 0:
                ...
                show marksprite upleft stand at markloc
                show ellysprite upright stand at ellyloc
                show stsprite downleft stand1 at npc2loc
            if _return == 1:
                $ naoyax = markx+60
                $ naoyay = marky+25
                show marksprite downright standmove at markloc
                ...
                $ naoyax = npc2x-90
                $ naoyay = npc2y+60
                show stsprite downleft standmove at npc2loc
                show naoyasprite upright stand at naoyaloc with qdis
                ...
                hide stclerk with qdis
                show stsprite downleft stand1
                hide naoyasprite
                with qdis
                $ label044ast = 1
            elif _return == 6:
    ...
    if plotprogress == 0:
        ...
        label label044TalkA:
            ...
            if _return > 0:
                ...
                show yukinosprite upright stand at yukinoloc
                show marksprite upleft stand at markloc
                show woman2sprite upright stand at npc1loc
                show stsprite downleft stand1 at npc2loc
            if _return == 1:
                $ naoyax = markx+60
                $ naoyay = marky+25
                ...
                $ naoyax = npc1x-60
                $ naoyay = npc1y+25
                show woman2sprite downleft standmove at npc1loc
                show naoyasprite upright stand at naoyaloc with qdis
                woman "Hey, don't you think it's weird, too?  I mean that Kaneda!"
                woman "In the space of only a year, she's struck it rich somehow!"
                woman "It's suspicious, if you ask me... Veeeery suspicious!"
                show woman2sprite upright stand
                hide naoyasprite
                with qdis
                $ label044woman = 1
            elif _return == 5:
...
label label045 (location="Judgment 1999"): #Judgment 1999 Mikage
    if plotprogress == 1:
        ...
        if ellycasino == 0:
            ...
            show ellysprite upright standmove
            show elly animated neutral serious with qleft
            ...
            hide elly with qdis
            show man1sprite downleft standmove
            show ellysprite upright stand
            man "Uh... O-Okay..."
            $ ellycasino = 1
            jump label045
            ...
            label label045TalkB:
                ...
                if _return == 1:
                    ...
                    $ naoyax = ellyx+60
                    $ naoyay = ellyy+25
                    show ellysprite downright standmove at ellyloc
                    show naoyasprite upleft stand at naoyaloc with qdis
                    show elly animated neutral serious
    ...
    if plotprogress == 2:
        ...
        label label048TalkA:
            ...
            if _return > 0:
                ...
                show yukinosprite downright stand at yukinoloc
                show marksprite downright stand at markloc
                show hssprite downright stand1 at npc1loc
            if _return == 1:
                $ naoyax = markx+60
                $ naoyay = marky+25
                show marksprite downright standmove at markloc
                ...
                $ naoyax = npc1x+60
                $ naoyay = npc1y+25
                show hssprite standmove at npc1loc
                show naoyasprite upleft stand at naoyaloc with qdis
                ...
                show hssprite downright stand1
                hide naoyasprite
                with qdis
                $ label048woman1 = 1
            elif _return == 5:
                "You go further within."
                jump label049
            elif _return == 6:
                hide nanjosprite
                hide naoyasprite
...
label label049: #Historical society inside
    ...
    label label049TalkA:
        ...
        if _return > 0:
            ...
            show yukinosprite upright stand at yukinoloc
            show marksprite upleft stand at markloc
            show studentifm downright stand at npc1loc
            show girl1sprite upleft stand at npc2loc
        if _return == 1:
            $ naoyax = markx-60
            $ naoyay = marky-25
            show marksprite upleft standmove at markloc
            ...
            $ naoyax = npc1x+60
            $ naoyay = npc1y-25
            show studentifm upright standmove at npc1loc
            show naoyasprite downleft stand at naoyaloc with qdis
            stu "I came to see the {color=#800000}Expel Mirror{/color} display.  It's as divine as they say..."
            show studentifm downright stand
            hide naoyasprite
            with qdis
            $ label049ifstu1 = 1
            ...
            $ naoyax = npc2x-60
            $ naoyay = npc2y+15
            show girl1sprite downleft standmove at npc2loc
            show naoyasprite upright stand at naoyaloc with qdis
...
label label050: #police station
    if plotprogress == 2:
        ...
        show marksprite downright stand at markloc
        show naoyasprite downright stand at naoyaloc
        show lieutenantsprite downleft standmove at npc1loc
        show copfsprite downleft stand at npc2loc
        lieu "Well, if it isn't Masao.  You've been attending school, I hope?"
        lieu "Not causing trouble for your teachers, are you?"
        show lieutenantsprite downleft stand
        show copfsprite downleft standmove
        officer "That's a little harsh, Lieutenant.  You're no trouble anymore, right Masao?"
        show copfsprite downleft stand
        show mark animated neutral sad with qleft
        show marksprite downright standmove
        mk "Yeah, well... sorta..."
        hide mark with qdis
    ...
    if plotprogress == 0:
        ...
        label label053TalkA:
            ...
            if _return == 1:
                ...
                $ naoyax = npc1x-80
                $ naoyay = npc1y+55
                show rcsprite standmove at npc1loc
                show naoyasprite upright stand at naoyaloc with qdis
    ...
    if plotprogress == 1:
        ...
        label label054TalkB:
            ...
            if _return == 1:
                ...
                $ naoyax = ellyx+60
                $ naoyay = ellyy-25
                show ellysprite upright standmove at nanjoloc
                show naoyasprite downleft stand at naoyaloc with qdis
                show elly animated neutral serious with qleft
                ...
                show naoyasprite upleft stand at naoyaloc with qdis
                yao "That strange store in this mall will apparently be open soon."
                yao "Don't ask me when, though."
    ...
    if plotprogress == 1:
        ...
        label label055TalkB:
            ...
            if _return > 0:
                ...
                show ellysprite upright stand at ellyloc
                show yinyansprite downleft stand1 at npc1loc
                show man1sprite downleft stand at npc2loc
                show man2sprite downright stand at npc3loc
            if _return == 1:
                $ naoyax = markx+60
                $ naoyay = marky+25
                show marksprite downright standmove at markloc
                ...
                $ naoyax = npc2x-60
                $ naoyay = npc2y+25
                show man1sprite downleft standmove at npc2loc
                show naoyasprite upright stand at naoyaloc with qdis
                ...
                hide naoyasprite
                with qdis
                $ label055acustomer1 = 1
            elif _return == 7:
                $ naoyax = npc3x+60
                $ naoyay = npc3y+25
                show man2sprite downright standmove at npc3loc
                show naoyasprite upleft stand at naoyaloc with qdis
                ...
                show man2sprite downleft stand
                hide naoyasprite
                with qdis
                $ label055acustomer2 = 1
            elif _return == 8:
                scene bg yinyan with qdis
                hide screen header
                "You head back out into the mall."
        ...
        label label055TalkA:
            ...
            if _return > 0:
                ...
                show marksprite downleft stand at markloc
                show yinyansprite downleft stand1 at npc1loc
                show reijimomsprite downright stand at npc2loc
            if _return == 1:
                $ naoyax = markx+60
                $ naoyay = marky+25
                show marksprite downright standmove at markloc
                ...
                $ naoyax = npc2x+60
                $ naoyay = npc2y+25
                show reijimomsprite downright standmove at npc2loc
                show naoyasprite upleft stand at naoyaloc with qdis
                if reijimom == False:
                ...
                show reijimomsprite downright stand
                hide naoyasprite
                with qdis
                $ reijimomlabel055 = 1
            elif _return == 5:
    ...
    if plotprogress == 1:
        ...
        label label056TalkA:
            ...
            if _return > 0:
                ...
                show marksprite downright stand at markloc
                show student5 downright stand at npc2loc
                show pdsprite downleft stand1 at npc1loc
            if _return == 1:
                $ naoyax = markx+60
                $ naoyay = marky-25
                show marksprite upright standmove at markloc
                ...
                show naoyasprite upright stand at naoyaloc with qdis
                show yukino animated neutral serious with qleft
                yu "Summoning demons... I don't think it'd be anything to joke about if it actually happened."
                show yukinosprite upleft stand
                hide yukino
                hide naoyasprite
                with qdis
                ...
                show student5 downleft standmove at npc2loc
                show naoyasprite upright stand at naoyaloc with qdis
                stu "Right now, I'm into this card game called 'Persona'..."
                stu "You use these things called 'Spell Cards' to summon demons."
                stu "Man, can you imagine if you could really do that?  Wouldn't that be wild?"
                show student5 downright stand
                hide naoyasprite
                with qdis
                $ label056stu = 1
                ...
                $ naoyax = npc1x-90
                $ naoyay = npc1y+60
                show pdsprite downleft standmove at npc1loc
                show naoyasprite upright stand at naoyaloc with qdis
                show pdclerk at pleft2 with qleft
    ...
    if plotprogress == 1:
        ...
        label label057TalkB:
            ...
            if _return > 0:
                ...
                show yukinosprite upright stand at yukinoloc
                show marksprite upleft stand at markloc
                show ellysrpite upright stand at ellyloc
                show man1sprite upright stand at npc1loc
                show stsprite downleft stand1 at npc2loc
            if _return == 1:
                $ naoyax = markx+60
                $ naoyay = marky+25
        ...
        label label057TalkA:
            ...
            if _return == 1:
                ...
                show man1sprite downleft standmove at npc1loc
                show naoyasprite upright stand at naoyaloc with qdis
                man "I went to the park and saw a tree that wasn't there before.  You should go look."
                show man1sprite downleft stand
                hide naoyasprite
                hide man1sprite
                with qdis
...
label label062 (location = "SEBEC Building"):
    ...
    if plotprogress == 1:
        ...
        if reijisebec == False:
            ...
            na "So even you will lend a hand to others... Interesting.  I wouldn't have thought it."
            hide nanjo
            show mark animated serious with qleft
...
#            $ tbnarrator = 0
            ...
            $ newlocx = 1030
            $ newlocy = 400
            show nanjosprite upright walk at newloc with MoveTransition(1.0)
            $ nanjox = 1030
            $ nanjoy = 400
            show nanjosprite upright standmove
            show nanjo animated neutral serious with qleft
            ...
            na "Kandori..."
            hide nanjo
            show bg black zorder 1 with qdis
            $ npc3x = 1150
            $ npc3y = 345
            window auto
            hide bg black
            show bg sebecreception zorder 0
            show naoyasprite upright stand at naoyaloc zorder 1
            show marksprite upright stand at markloc zorder 1
            show yukinosprite upright stand at yukinoloc zorder 1
            show nanjosprite upright stand at nanjoloc zorder 1
            show takedasprite downleft stand at npc1loc zorder 1
            show sebecsecsprite downleft stand1 at npc2loc zorder 1
            show kandorispritea downleft stand at npc3loc zorder 1
            with qdis
            ...
            show kandori
            $ tbnarrator = 1
            n "{color=#0ff}>Takahisa Kandori\nThe ambitious branch president of SEBEC.  Sinister rumors circulate about him...{/color}"
            $ tbnarrator = 0
            hide kandori
            show nanjosprite upright standmove
            show nanjo animated neutral serious with qleft
            ...
            hide kandorispritea
            show kandorispriteb downleft standmove at npc3loc
            with qdis
            kan "But Nanjo... I will teach you the proper form of address to your betters."
            hide kandorispriteb
            show kandorispritea downleft stand at npc3loc
            with qdis
            hide kandori
            show marksprite upright standmove
            show mark animated neutral serious with qleft
            ...
            hide takeda
            show kandori animated neutral serious with qleft
            show kandorispritea upleft standmove
            kan "Yes, I'll be right there."
            show kandorispritea downleft standmove
            kan "Now then, the time has come for me to ask you all to leave."
            show kandorispritea downleft stand
            hide kandori
            show mark animated neutral smirk with qleft
            show marksprite downleft standmove
            ...
            window hide
            window auto
            show bg sebecreception zorder 3 with qdis
            $ tbnarrator = 0
            $ Sebec1 = True
            hide screen header
            jump calloverworld
        if Sebec1 == True:
            ...
            show nanjosprite upright stand at nanjoloc
            show sebecsecsprite downleft stand1 at npc2loc
            sec "Excuse me, do you have an appointment?"
            sec "I'm sorry, but if you don't have one, I must ask you to leave."
            $ tbnarrator = 1
            "You return back to the streets of Mikage-Cho."
            window hide
            window auto
